...
var OPTION_LEAVE_FORMULA_AS_A_COMMENT = true;
...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c21 = function(fn, expr, append) { 
                var str = (fn? fn:"") + "(" + expr;
                if(append){
        ...
        peg$c22 = peg$otherExpectation("sign"),
        peg$c23 = function(sigarray) {
                return solveSIg(sigarray);
            },
        peg$c24 = peg$otherExpectation("decimal"),
        peg$c25 = /^[0-9]/,
        peg$c26 = peg$classExpectation([["0", "9"]], false, false),
        peg$c27 = ".",
        peg$c28 = peg$literalExpectation(".", false),
        peg$c29 = function() { return decimalConstractor + "\"" + text() + "\")" },
        ...
        peg$c36 = peg$otherExpectation("whitespace2"),
        peg$c37 = /^[ \t\n\r]/,
...
if( selectedTxt.length != 0){
   try{
      var textFirst = OPTION_LEAVE_FORMULA_AS_A_COMMENT? "/*" + selectedTxt + "*/ ": "";
      var textJavCd = JDecConverter.parse(selectedTxt);

      Editor.InsText( textFirst + textJavCd );
   }catch(e){
